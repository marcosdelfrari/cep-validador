...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-black font-sans p-4">
      <main className="flex w-full max-w-7xl flex-col gap-8 bg-zinc-900 p-8 rounded-xl shadow-lg">
        <div className="flex flex-col gap-2">
          <h1 className="text-3xl font-bold text-zinc-50">Validador de CEP</h1>
        ...
        <div className="flex flex-col gap-4">
          <textarea
            className="w-full h-40 p-4 rounded-lg border border-zinc-800 bg-zinc-950 text-zinc-50 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none font-mono"
              ...
              <div className="flex flex-col gap-2 max-h-[500px] overflow-y-auto pr-2">
                {validCeps.length === 0 ? (
                  ...
                  validCeps.map((result, idx) => (
                    <div
                      key={idx}
                      className="p-4 rounded-lg border border-green-900 bg-green-950/30"
                    >
              ...
              <div className="flex flex-col gap-2 max-h-[500px] overflow-y-auto pr-2">
                {invalidCeps.length === 0 ? (
                  ...
                  invalidCeps.map((result, idx) => (
                    <div
                      key={idx}
                      className="p-4 rounded-lg border border-red-900 bg-red-950/30"
                    >
        ...
        <footer className="text-sm text-zinc-400"> Feito para Jaqueline</footer>
      </main>
    </div>
  );
}
